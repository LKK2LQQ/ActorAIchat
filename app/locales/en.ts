...
const en: LocaleType = {
  WIP: "Coming Soon...",
  Error: {
    Unauthorized: `Want to use your own OpenAI resources? [Click here](/#/settings) to change settings ⚙️`,
  },
  Auth: {
    Return: "Return",
    ...
    TopTips:
      "🥳 ActorAIchat launch promotion: Instantly unlock the latest models like OpenAI o1, GPT-4o, Claude-3.5!",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Use ActorAIchat",
        Label: " (Most Cost-Effective Option)",
        SubTitle:
          "Maintained by ActorAIchat, zero setup needed, unlock OpenAI o1, GPT-4o," +
          " Claude-3.5 and more",
        ChatNow: "Start Now",
      },
      AccessCode: {
